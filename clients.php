...
$req=$bdd->prepare("Select * from t_client where etat=1 order by client");
$req->execute(array());
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="breadcome-heading">
                                            <h3>G-STOCK-Clients</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                       <div class="modal-area-button">
                               <a class="Warning Warning-color mg-b-10" href="#" data-toggle="modal" data-target="#WarningModalftblack" style="font-weight: bolder; letter-spacing: 0.1em;"><i class="fa fa-plus-square"></i> Nouveau Client</a>
            ...
            <div class="container-fluid">
                <div class="row">
                  ...
                  <?php } ?>
                         ...
                         <h1 style="color:white;font-size: 16px !important;letter-spacing: 0.2em"><i class="fa fa-product-hunt"></i> Liste <span class="table-project-n">des</span> Clients</h1>
                                </div>
                                        ...
                                        <tbody>
                                           ...
                                           <tr >
                                             <td><span class='badge bg-success' style='font-size: 0.9em; padding: 6px 12px 6px 12px ; background-color: #141F29;'><?=$k;?></span></td>
                                              ...
                                              <td><?=$lignes['id_cli'];?></td>
												<td> <span style="font-weight: bolder;"><?=$lignes['client'];?></td>
												<td><span style="font-weight: bolder;"><?=$lignes['nom_client'];?></td>
												<td><span style="font-weight: bolder;"><?=$lignes['adrs'];?></td>
												<td><?=$lignes['user_id'];?></td>
