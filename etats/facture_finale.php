              ...
              //$Convert2=explode("-",$_POST['date_fin']);             
               ...
               //$date2=date($Convert2[2].'-'.$Convert2[1].'-'.$Convert2[0]);
                ...
                $adrs=$ligne['adrs_cli'];
                 ...
                 ?>       
        <h4 style="" ><u><center>FACTURE N°    <?php echo '00'.$ligne['id_lgne']."/".$date1;?> <!--hr style="margin-top:8px;margin-bottom: 0px;"--></center></u></h4>              
        <?php  
        /*}
        else {*/
                        ...
                        if ($lignes['devise']=='dollar'){ 
                            $dev_symbole='$'; $devise='en dollar'; } 
                              ...
                              ?>
                                 ...
                                 <div class="float-left" style="float: left; margin-bottom: 25px;margin-bottom: 13%">  
                                  Nous disons :  <b> <?php echo $devise1; chifre_en_lettre($cpt_tot_vente_dol, $devise1='', $devise2='');?></b><br><br>
                                  </div>
