...
$mode_impr=1;
 ...
 $vue_ventes_par_ref="Select t_ligne_cmd.id_lgne,t_ligne_cmd.desi_prod, t_ligne_cmd.ref_cmd, t_ligne_cmd.client, t_ligne_cmd.adrs_cli,t_ligne_cmd.qte_achet,t_ligne_cmd.unite, t_ligne_cmd.prix_unit, t_ligne_cmd.devise, t_ligne_cmd.prix_total,SUBSTRING(t_ligne_cmd.creer_le,1,10) AS date_fact, t_ligne_cmd.ref_prod, t_produits.ref_prod as prod_ref_prod, t_produits.Descript as descrip from t_ligne_cmd, t_produits where t_ligne_cmd.ref_prod=t_produits.ref_prod AND t_ligne_cmd.ref_cmd=? order by t_ligne_cmd.creer_le DESC";
...
<section class="invoice">
    <div class="col-md-7 col-md-offset-3">
       ...
       <!--hr style="border: 2px double black;"-->
        <div class="float-right" style="float: right; margin-bottom:11%">  <b>Kinshasa le : </b> <?php echo date('d-m-Y');?></div>
        </div>
        <br>
               ...
               //$date2=date($Convert2[2].'-'.$Convert2[1].'-'.$Convert2[0]);
                ...
                $adrs=$ligne['adrs_cli'];
                 if ($ligne['devise']=='dollar'){ 
                            ...
                            else{  $dev_symbole1='CDF'; $devise1='Francs Congolais'; $dev_symbole2='FC';}
                }
                 ?>       
        <h4 style="" ><u><center>BON DE LIVRAISON N°    <?php echo '00'.$ligne['id_lgne']."/".$date1;?> <!--hr style="margin-top:8px;margin-bottom: 0px;"--></center></u></h4>              
        <?php  
        /*}
        else {*/
                            ...
                            $dev_symbole='$'; $devise='en dollar'; } 
                              ...
                              ?>
                                           <tr >
                                            ...
                                            <!--td ><span style=""><center><?=$lignes['ref_cmd'];?></span></td-->
                                            <!--td ><span style=""><?=$lignes['descrip'];?></span></td-->

                                            <td><center><?php echo '0'.$lignes['qte_achet']; ?></center></td>
                                          ...
                                          <tfoot style="background: linear-gradient(179deg,#00b09b ,#96c93d 73%) !important; color:white;font-size: 10px !important;text-align: center !important;">
                                            <!--tr >
                                                ...
                                                <th colspan="5"  style="text-align: center;"></th><br/><br/><br/>
                                                  <!--th colspan="3" style="font-size:0.9em;text-align: left; font-weight: bold; letter-spacing: 0.1em;">NOMBRE TOTAL DU STOCK</th>
                                                   <th colspan="2" style="text-align: right;font-weight:bold; font-size:0.9em;"><?php echo $cpt_tot_stock." Article (s)"; ?></th>
                                                  </tr>

                                                   <tr >
                                                    <th colspan="2" style="text-align: center;"></th>
                                                    <th colspan="3" style="font-size:0.9em;text-align: left; font-weight: bold; letter-spacing: 0.1em;">NOMBRE TOTAL ARTICLE(S)</th>
                                                   <th colspan="2" style="text-align: right;font-weight:bold; font-size:0.9em;"><?php echo $cpt_tot_stock." Article (s)"; ?></th>
                                                  </tr>
                                                  ...
                                                  <!--tr>
                                                    ...
                                                    <th colspan="2" style="text-align: center;"></th>
                                                    <th colspan="3" style="font-size:0.9em;text-align: left; font-weight: bold; letter-spacing: 0.1em;">MOTANT TOTAL A PAYER EN (<?=$dev_symbole1;?>)</th>
                                                     <th colspan="2" style="text-align: right;font-weight: bold;letter-spacing: 0.1em; font-size:0.9em;"><?php echo number_format($cpt_tot_vente_dol,0,',','.')." ".$dev_symbole2;?></th>
                                 ...
                                 <div class="float-left" style="float: left; margin-bottom: 25px;">  
                                  <b>Pour la livraison </b>  <!--b> <?php echo $devise1;?></b><br><br-->
                                  </div>
                                  <div class="float-right" style="float: right; margin-bottom: 13%">  
                                  <b>Pour la reception </b>  <!--b> <?php echo $devise1;?></b><br><br-->
                                  </div>
                               ...
                               <footer> 
                                  <!--img src="../img/pied.jpg" style="margin-bottom: -10px; margin-left: 26px !important;"--> <br>
