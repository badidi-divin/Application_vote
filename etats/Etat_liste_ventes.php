...
$mode_impr=1;
 ...
 if(isset($_GET['date_d']) AND isset($_GET['date_f'])){
  ...
  $req=$bdd->prepare("Select t_ligne_cmd.desi_prod, t_ligne_cmd.ref_cmd, t_ligne_cmd.qte_achet,t_ligne_cmd.unite, t_ligne_cmd.prix_unit, t_ligne_cmd.devise, t_ligne_cmd.prix_total,t_ligne_cmd.creer_le,t_ligne_cmd.type_vente, t_ligne_cmd.ref_prod, t_produits.ref_prod as prod_ref_prod, t_produits.Descript as descrip from t_ligne_cmd, t_produits where t_ligne_cmd.ref_prod=t_produits.ref_prod AND SUBSTRING(t_ligne_cmd.creer_le,1,10)>=? AND SUBSTRING(t_ligne_cmd.creer_le,1,10)<=? order by desi_prod DESC");
        ...
        <table class="table table-bordered table-responsive-sm">
            <thead class="bg-default-gradient">
                <tr >
                  ...
                  <th style="text-align: center; font-size:0.9em;">QTE</th>
